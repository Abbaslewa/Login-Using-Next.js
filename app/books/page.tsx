  ...
  const books = [
    {
      ...
      image: "/com.jpeg", // ✅ fixed extension
    },
    {
      id: 2,
      ...
      image: "/ox.jpeg", // ✅ your Oxford image
    },
    {
      id: 3,
      ...
      image: "/brige.jpg", // ✅ corrected spelling
    },
    
  ];

  // fallback if image not found
  const fallbackImage = "/books/placeholder.jpg"; // 👈 add a placeholder in /public/books/
          ...
          >
            ...
            <div className="w-full h-64 relative mb-4">
              <Image
                ...
                fill
                onError={(e) => {
                  e.currentTarget.src = fallbackImage; // ✅ fallback if missing
                }}
