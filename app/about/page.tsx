  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="bg-blue-900 text-white py-16 px-6 text-center">
        ...
        <p className="text-lg sm:text-xl max-w-3xl mx-auto text-gray-200 leading-relaxed">
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto grid gap-10 md:grid-cols-3">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition">
            ...
            <ul className="list-disc text-gray-600 ml-5 mb-4 space-y-1">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition">
            ...
            <p className="text-gray-700 mb-4">
              Already confident in your English skills? Skip the course and earn
              an official certificate by passing our assessment test.
            </p>
            <ul className="list-disc text-gray-600 ml-5 mb-4 space-y-1">
